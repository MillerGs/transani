...
<html lang="en" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="/transani/images/images/faviconT.ico">
        <link href='http://fonts.googleapis.com/css?family=Ubuntu:400,500,700' rel='stylesheet' type='text/css'>
          <!--[if lt IE 9]><script src="js/modernizr.custom.js"></script><![endif]-->
        <link rel="stylesheet" type="text/css" href="/transani/assets/45f3164a/bootstrap/css/bootstrap.min.css" />

        <script src="http://www.transani.esy.es//transani/js/jquery.flexslider-min.js"></script>
        <script src="http://www.transani.esy.es//transani/js/functions.js"></script>
            ...
            <div class="shell">
                ...
                <div class="container">
                    ...
                    <header id="header">
                        ...
                        <div id="logos"><?php echo '<img style="position:absolute;" width="320px" src="' . Yii::app()->request->baseUrl . '/images/banner.png">'; ?></div>
                        <!-- search -->
                        <div class="search">
                    ...
                    <!-- end of navigation -->
                    <table style="margin: 100px 200px;">
                        <tr>
                            <td>
                        <center>
                            <h3>Ingrese su correo para recuperar contraseña</h3>
                            <form id="cliente-form" class="" action="/transani/index.php/Site/olvideContrasenia" method="POST">
                                <div class="row">
                                    <style>.rq{color:red}</style>
                                    <label for="Cliente_correo" class="required">Correo <span class="required rq">*</span></label>
                                    <input size="100" maxlength="200" name="Olvide[correo]" id="Cliente_correo" type="email"/>
                                    <br>
...
<table>
                        ...
                        <center>
                            <h3>Ingrese su correo para recuperar contraseña</h3>
                            <form id="cliente-form" class="" action="/transani/index.php/Site/olvideContrasenia" method="">
                                <div class="row">
                                    <style>.rq{color:red}</style>
                                    <label for="Cliente_correo" class="required">Correo <span class="required rq">*</span></label>
                                    <br>
                                    <input size="50" maxlength="70" name="Olvide[correo]" id="Cliente_correo" type="email"/>
                                    <br><br>
                                    <button type="submit" class="btn btn-success" value="Enviar">Enviar</button>
                                </div>
                            </form>
