...
class Sede extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('sede_desc, serie', 'required'),
			array('sede_desc', 'length', 'max'=>100),
			array('serie', 'length', 'max'=>3),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idsede, sede_desc, serie', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'oficinas' => array(self::HAS_MANY, 'Oficina', 'idsede'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('sede_desc',$this->sede_desc,true);
