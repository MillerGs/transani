            ...
            function fn_IniciarSesion() {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        $("#popupIniciarSesion").jqxWindow({height: 170});
            ...
            <div class="shell">
                ...
                <div class="container">
                    ...
                    <header id="header">
                        ...
                        <div id="logos"><?php echo '<img style="position:absolute;" height="70px" src="' . Yii::app()->request->baseUrl . '/images/banner.png">'; ?></div>
                        <!-- search -->
                        <div class="search">
                    ...
                    <!-- slider -->
                    <div class="m-slider">
                        <div class="slider-holder"> <span class="slider-shadow"></span> <span class="slider-b"></span>
                            <div class="slider flexslider">
                                <ul class="slides">
                                    <li>
                                        <div class="img-holder"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/slide-img11.png" alt=""> </div>
                                        <div class="slide-cnt">
                                            <h2>Servicio de Transporte</h2>
                                            <div class="box-cnt">
                                                <p>Servicio directo, realizado en buses de un piso con cómodos asientos reclinables y sistema de vídeo. Brinda al pasajero la misma seguridad y puntualidad que nuestros servicios especiales, a un precio más económico en las rutas hacia el norte del país.
                                                </p>  

                                            </div>
                                            <a href="#" class="grey-btn">Reservar Asiento</a> </div>
                                    </li>
                                    <li>
                                        <div class="img-holder"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/slide-img22.png" alt=""> </div>
                                        <div class="slide-cnt">
                                            <h2>Giros</h2>
                                            <div class="box-cnt">
                                                <p>Emisión de giros con entrega inmediata, gracias a la interconexión  informática de nuestros terminales   y con tarifas muy competentes.
                                                    Transporte de valores, contando con una póliza de protección ante pérdidas, robos y asaltos. Todas nuestras unidades cuentan con equipos GPS siendo monitoreadas en forma permanente.
                                                </p>
                                            </div>
                                            <a href="#" class="grey-btn">Ver Detalles</a> </div>
                                    </li>
                                    <li>
                                        <div class="img-holder"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/slide-img33.png" alt=""> </div>
                                        <div class="slide-cnt">
                                            <h2>Servicio de Encomiendas</h2>
                                            <div class="box-cnt">
                                                <p>“Seguridad y puntualidad en tus envíos…”

                                                    Nuestro equipo de trabajo y flota de última generación garantizan el traslado, en perfectas condiciones de sus envíos, brindándole seguridad y puntualidad en la entregas.
                                                </p>
                                            </div>
                                            <a href="#" class="grey-btn">Ver Detalles</a> </div>
                                    </li>
                    ...
                    <!-- end of slider -->
                    <!-- main -->
                    <div class="main"> <a href="#" class="m-btn-grey grey-btn">request a demo</a>
                        <section class="cols">
                            <div class="col"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/col-img1.png" alt="">
                                <div class="col-cnt">
                                    <h2>Pasajes</h2>
                                    <p>Lorem ipsum dolor sit amet, con-<br>
                                        sectetur adipiscing dolor emor</p>
                                    <a href="#" class="more">ver más</a> </div>
                            </div>
                            <div class="col"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/col-img2.png" alt="">
                                <div class="col-cnt">
                                    <h2>Giros</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing dolor</p>
                                    <a href="#" class="more">ver más</a> </div>
                            </div>
                            <div class="col"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/col-img3.png" alt="">
                                <div class="col-cnt">
                                    <h2>Encomiendas</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing dolor</p>
                                    <a href="#" class="more">ver más</a> </div>
                        ...
                        <section class="post">
                            <div class="video-holder"> <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/images/video-img.png" alt=""> </div>
                            <div class="post-cnt">
