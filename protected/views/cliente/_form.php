...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'tipodoc',array('1'=>'DNI','2'=>'Pasaporte')); ?>
		<?php echo $form->error($model,'tipodoc'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'nrodoc'); ?>
		<?php echo $form->textField($model,'nrodoc',array('size'=>20,'maxlength'=>20,'onKeyPress'=>'return checkIt(event)')); ?>
